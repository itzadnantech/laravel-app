            ...
            <div class="col-md-5 mx-auto">
                ...
                <div id="first">
                    <div class="myform form ">
                        ...
                        <form class="submit-form" action="{{ url('/vendor/login-request') }}" name="login">
                            ...
                            <div class="form-group">
                                <p class="text-center">Don't have account? <a href="javascript:void(0)" id="signup">Sign up here</a></p>
                            </div>
                        </form>
                ...
                <div id="second">
                    <div class="myform form ">
                        ...
                        <form class="submit-form" action="{{ url('/vendor/signup-request') }}" name="registration">
                            @csrf
                            <div class="alert alert-danger" role="alert" style="display: none;">
